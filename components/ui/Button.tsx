...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary: 'bg-iusven-blue text-white hover:bg-iusven-lightBlue focus:ring-iusven-blue',
    secondary: 'bg-iusven-gray text-iusven-textDark border border-iusven-lightBlue hover:bg-gray-200 focus:ring-iusven-lightBlue',
    accent: 'bg-accent text-white hover:bg-accent-dark focus:ring-accent',
    danger: 'bg-red-500 text-white hover:bg-red-600 focus:ring-red-500',
    ghost: 'bg-transparent text-iusven-blue hover:bg-blue-50 focus:ring-iusven-blue',
  };
